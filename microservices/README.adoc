...
| `ADMIN_ROLE` | The default role required to create, edit and delete dashboards and elements set within keycloak. | `scs-admin`
| `SUPER_ADMIN_ROLE` | The default super role required to adjust general settings, dataplattform connections, tenant management and corporate design. | `scs-super-admin`
