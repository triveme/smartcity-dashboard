  ...
  if (dataDb === undefined || dataDb === null || getDbDiffHours(dataDb) >= 24) {
    ...
    try {
      if (dataRest !== undefined) {
        ...
        console.log(`Fetched ${dataType} data with length of ${dataRest.features.length}`);
    ...
    console.log(`Found up to date db ${dataType} with length of ${dataDb.features.length}`);
