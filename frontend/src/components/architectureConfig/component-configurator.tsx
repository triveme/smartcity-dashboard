...
export function ComponentConfigurator(props: ComponentConfiguratorProps) {
  ...
  return (
    <Box
      width="inherit"
      height="inherit"
      key="box-component-configurator"
    >
      <Select
        size="small"
        autoWidth
        ...
        onChange={(e) =>
          setNewTabValue([{ key: "componentType", tabValue: e.target.value }])
        }
      ...
      {tempPanel.tabs[currentTabIndex].componentType === "pois" ||
       tempPanel.tabs[currentTabIndex].componentType === "map" ? (        
        <Select
          ...
          onChange={(e) =>
            setNewTabValue([{ key: "componentDataType", tabValue: e.target.value }])
          }
          style={{ backgroundColor: colors.backgroundColor }}
        >
       ...
       {tempPanel.tabs[currentTabIndex].componentType === "measurement" ? (
         <Box display="flex" flexDirection="row" gap="5px">
          <SmallField
            ...
            onChange={(e) =>
              setNewTabValue([
                { key: "componentWarning", tabValue: e.target.value },
              ])
            }
          />
          <SmallField
            ...
            onChange={(e) =>
              setNewTabValue([
                { key: "componentAlarm", tabValue: e.target.value },
              ])
            }
          />
          <SmallField
