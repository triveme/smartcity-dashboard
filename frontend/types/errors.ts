export type WizardErrors = {
  ...
  listviewContactAttributeError?: string;
  listviewImageAttributeError?: string;
  listviewCategoryAttributeError?: string;
  listviewNameAttributeError?: string;
  listviewContactNameAttributeError?: string;
  listviewContactPhoneAttributeError?: string;
  listviewParticipantsAttributeError?: string;
  listviewSupporterAttributeError?: string;
  listviewEmailAttributeError?: string;
  listviewWebsiteAttributeError?: string;
  listviewDescriptionAttributeError?: string;
  liveUrlError?: string;
